...
//        then add the value of the product category from the request to the product
    ...
    @Override
    public UpdateProductResponse update(Long productId, JsonPatch patch) throws ProductNotFoundException {
//        find product
        var foundProduct =
...
//        throw new ProductNotFoundException(String.format("Product with id %d not found", id));
    ...
    @Override
    public DeleteProductResponse deleteProduct(Long id) throws ProductNotFoundException {
